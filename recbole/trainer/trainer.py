...
#         weight_decay = kwargs.pop("weight_decay", self.weight_decay)
#         opt1 = optim.Adam(
#                 [{'params': self.model.item_embedding.parameters()},
#                  {'params': self.model.user_embedding.parameters()},
#                  {'params': self.model.position_embedding.parameters()},
#                  {'params': self.model.LayerNorm1.parameters()},
#                  {'params': self.model.LayerNorm2.parameters()},
#                  {'params': self.model.trm_encoder.parameters()},
#                  {'params': self.model.attacker.parameters()},
#                  {'params': self.model.causaler.parameters()},
#                  {'params': self.model.model.parameters()},
#                  {'params': self.model.gd.parameters()},
#                  ],
#                  lr=learning_rate,
#                  weight_decay=weight_decay
#             )
...
#             "state_dict": self.model.state_dict(),
#             "other_parameter": self.model.other_parameter(),
#             "optimizer": (self.optimizer[0].state_dict(), self.optimizer[1].state_dict())
#         }
#         torch.save(state, saved_model_file, pickle_protocol=4)
#         if verbose:
#             self.logger.info(
